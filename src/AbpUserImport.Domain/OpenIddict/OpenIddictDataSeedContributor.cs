...
namespace AbpUserImport.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AbpUserImport") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AbpUserImport", DisplayName = "AbpUserImport API", Resources = { "AbpUserImport" }
            });
        }
    }
